...
type ChannelInsight struct {
	...
	//
	//The ratio of htlc failures to total htlcs processed by the channel. This
	//value excludes our own sends an receives.
	FailureRatio         float32  `protobuf:"fixed32,9,opt,name=failure_ratio,json=failureRatio,proto3" json:"failure_ratio,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ChannelInsight) GetFailureRatio() float32 {
	if m != nil {
		return m.FailureRatio
	}
	return 0
}
...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	,
}
