...
Known Omissions: 
- If a channel was closed before we started saving our channel information for use after close (<lnd 0.9), we will not be able to calculate fees and the report will fail. 
